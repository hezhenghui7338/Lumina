...
from lumina_core.config import MAX_FILE_BYTES
...
def load_document(path: Path, fmt: str) -> tuple[str, dict[str, Any]]:
...
def build_segments(book_id: str, text: str) -> list[dict]:
